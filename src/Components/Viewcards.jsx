...
export const Viewcards = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-50 py-4 px-3 sm:px-6 font-poppins">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 max-w-6xl mx-auto">
        <div className="relative h-[500px] sm:h-[550px] w-full rounded-xl overflow-hidden">
          ...
          <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-20">
            <button
              ...
              className="flex items-center gap-2 bg-pink-700 text-white font-semibold px-5 py-2 rounded-full shadow-lg hover:scale-105 transition-transform duration-300"
            >
        ...
        <Card className="shadow-xl rounded-2xl py-3 px-4 ">
          ...
          <div className="grid sm:grid-cols-2 gap-x-4 gap-y-3 text-gray-800 text-sm sm:text-base mb-4">
          ...
          <div className="bg-white border border-pink-300 rounded-lg p-4">
            <h3 className="text-base sm:text-lg font-semibold text-pink-700 mb-2 flex items-center gap-2">
